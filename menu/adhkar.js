...
export const adhkar = {
    ...
    async exec({ from, client, body, id }) {
        ...
        if (body === '1'){
            ...
            await client.reply(from, adhkar_sbh, id).catch((erro) => console.log(erro));
        }

        else if (body === '2'){

            let adhkar_msa = fs.readFileSync('./media/text/adhkar_msa.txt',{encoding:'utf8', flag:'r'})
            await client.reply(from, adhkar_msa, id).catch((erro) => console.log(erro));
            ...
            await client.reply(from, adhkar_nom, id).catch((erro) => console.log(erro));
            ...
            await client.reply(from, listadk, id).catch((erro) => console.log(erro));
            ...
            await client.reply(from, ad3yh_nboyh, id).catch((erro) => console.log(erro));
            ...
            await client.reply(from, adhkar_al2dan, id).catch((erro) => console.log(erro));
            ...
            await client.reply(from, adhkar_almsgd, id).catch((erro) => console.log(erro));
            ...
            await client.reply(from, adhkar_alwdo2, id).catch((erro) => console.log(erro));
            ...
            await client.reply(from, adhkar_home, id).catch((erro) => console.log(erro));
            ...
            await client.reply(from, adhkar_al5la, id).catch((erro) => console.log(erro));
            ...
            await client.reply(from, adhkar_food, id).catch((erro) => console.log(erro));
            ...
            await client.reply(from, adhka_5tm, id).catch((erro) => console.log(erro));
