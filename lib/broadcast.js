        ...
        setInterval(async function () {
            ...
            if (time_adhkar_all.includes(time)) {
                ...
                for (let lop of group_user) {
                    ...
                    await client.sendAudio(lop, listquran.FilePath).catch((erro) => console.log(erro));
                    await client.sendText(lop, msg).catch((erro) => console.log(erro));
                }
                ...
                for (let lop of group_user) {
                    ...
                    await client.sendFile(lop, listlectures.FilePath, 'video.mp4', msg).catch((erro) => console.log(erro));
                }
            ...
            //         await client.sendFile(lop, url_mp3).catch((erro) => console.log(erro));
            //         await client.sendText(lop, msg).catch((erro) => console.log(erro));
            //     }
